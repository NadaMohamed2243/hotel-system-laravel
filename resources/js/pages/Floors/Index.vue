    ...
    <AppLayout>
        <div class="flex flex-col gap-4 p-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                ...
                <Button @click="openAddDialog" v-if="canCreate"> Add Floor </Button>
            </div>
                ...
                <CardContent class="p-0">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow v-for="floor in floors.data" :key="floor.id">
                                ...
                                <TableCell class="text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <Button variant="outline" size="sm" @click="openEditDialog(floor)" :disabled="!floor.can_edit">
                                        ...
                                        <Button
                                            ...
                                            :disabled="!floor.can_delete || floor.room_count > 0"
                                        >
                            ...
                            <TableRow v-if="floors.data.length === 0">
                                <TableCell colspan="5" class="py-8 text-center text-muted-foreground"> No floors found </TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                    ...
                    <div class="flex items-center justify-between border-t px-4 py-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <Button variant="outline" size="sm" @click="goToPage(1)" :disabled="pagination.pageIndex === 0">
                                <ChevronsLeft class="h-4 w-4" />
                            </Button>

                            <Button variant="outline" size="sm" @click="goToPage(pagination.pageIndex)" :disabled="pagination.pageIndex === 0">
...
import { ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Eye } from 'lucide-vue-next';
...
const handleFloorCreated = (newFloor) => {
    // Always refresh the data from server for consistency
    router.visit(route(route().current()), {
        data: {
            page: 1, // Always go to first page for new items
            pageSize: pagination.pageSize,
        },
        preserveState: true,
        only: ['floors'],
    ...
    if (floorToDelete.value) {
        ...
        router.delete(`${routePrefix}/floors/${floorToDelete.value.id}`, {
            ...
            onError: (errors) => {
                ...
                if (errors.message) {
                    alert(errors.message); // Temporary - replace with your notification system
                }
                floorToDelete.value = null;
            },
            preserveScroll: true,
